                        ...
                        <div class="align-items-start bg-dark col-12">
                            <div class="row g-1 text-center">
                                ...
                                <div class="col-12 mt-5">
                                    <h4 class="text-white"><?php echo $_SESSION["a"]["f_name"] . " " . $_SESSION["a"]["l_name"]; ?></h4>
                        ...
                        <div class="offset-1 col-10 col-lg-4 mt-3 mb-3 rounded bg-light">
                            <div class="row g-1">
                                ...
                                ?>
                                    ...
                                    <div class="col-12">
                                        <img src="<?php echo $code["code"]; ?>" class="img-fluid rounded-top" style="height: 250px;margin-left: 40px;" />
                                        <hr />
                                    </div>
                        ...
                        <div class="offset-1 col-10 col-lg-4 mt-3 mb-3 rounded bg-light">
                            <div class="row g-1">
                                ...
                                ?>
                                    ...
                                    $profileimg = Database::search("SELECT * FROM `user_img` WHERE `user_email`='" .  $pdeatails["user_email"] . "' ");
                                    ...
                                    <div class="col-12">
                                        <img src="<?php echo $pcode["code"]; ?>" class="img-fluid rounded-top" style="height: 250px;margin-left: 20px;" />
                                        <hr />
                                    </div>
                                    <div class="col-12 text-center">
                                ...
                                <?php
                                    ...
                                    <hr />
                                    <div class="col-12">
                                        <img src="resources/profiles/profile.png" class="img-fluid rounded-top" style="height: 250px;margin-left: 20px;" />
                                    </div>
                                <?php
                                }
                                ?>
