...
if (empty($fname)) {
    ...
    Database::iud("INSERT INTO user (`email`,`fname`,`lname`,`password`,`mobile`,`rejister_date`,`gender_id`,`status_id`) VALUES ('".$email."','".$fname."','".$lname."','".$password."','".$mobile."','".$date."','".$gender."','".$status."')");
    echo "Success";
